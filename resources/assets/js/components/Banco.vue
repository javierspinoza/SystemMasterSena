        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" @click="abrirModal('bancos','registrar')" class="btn btn-success btn-sm" >
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <md-card-actions>
                            <md-button type="submit" v-if="tipoAccion==2" class="md-dense md-raised md-primary" :disabled="sending" @click="actualizarBanco()">Actualizar</md-button>
                        </md-card-actions>
                    </div>
                </div>
                <!-- /.modal-content -->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            let me = this;
                ...
                $(document).ready(function() {
                    ...
                    $('#dataTable tbody').on( 'click', '.editar', function () {
                        ...
                        me.abrirModal('bancos','actualizar',me.datos);
                    });
                    $('#dataTable tbody').on( 'click', '.eliminar', function () {
                        me.datos= table.row( $(this).parents('tr') ).data();
                        me.eliminarBanco(me.datos);
                    });
                });
            },
            registrarBanco() {
                let me = this;
                    axios.post(this.ruta + '/banco/registrar',{
            ...
            axios
                .put(this.ruta + "/banco/actualizar", {
                nombre: this.form.nombre.toUpperCase(),
                id: this.id_banco
                })
                .then(function(response) {
            ...
            eliminarBanco(data = []) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        this.id_banco = data["id"];
                        axios
                        .post(this.ruta + "/banco/eliminar", {
                        id: this.id_banco
                        })
                        .then(function(response) {
                            me.listarBanco();
            ...
            abrirModal(modelo, accion, data = []) {
                switch (modelo) {
                    case "bancos": {// libro de el boton nuevo al inicio
                        switch (accion) {
                            case "registrar": {
                            this.modal = 1;
                            this.form.nombre="";
