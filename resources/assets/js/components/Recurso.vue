        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> Recursos 
                    <button type="button" @click="abrirModal('recursos','registrar')" class="btn btn-success btn-sm" >
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <md-card-actions>
                            <md-button type="submit" v-if="tipoAccion==2" class="md-dense md-raised md-primary" :disabled="sending" @click="actualizarRecurso()">Actualizar</md-button>
                        </md-card-actions>
                    </div>
                </div>
                <!-- /.modal-content -->
        ...
        methods: {
            ...
            listarRecurso() {
                ...
                axios.get(this.ruta + url).then(function (response) {
                    ...
                    me.arrayRecurso = respuesta.recursos.data;
                    me.myTable(me.arrayRecurso);
                })
            ...
            let me = this;
                ...
                $(document).ready(function() {
                    ...
                    $('#dataTable tbody').on( 'click', '.editar', function () {
                        ...
                        me.abrirModal('recursos','actualizar',me.datos);
                    });
                    $('#dataTable tbody').on( 'click', '.eliminar', function () {
                        me.datos= table.row( $(this).parents('tr') ).data();
                        me.eliminarRecurso(me.datos);
                    });
                });
            },
            registrarRecurso() {
                let me = this;
                    axios.post(this.ruta + '/recursos/registrar',{
            ...
            axios
                .put(this.ruta + "/recursos/actualizar", {
                nombre: this.form.nombre.toUpperCase(),
                id: this.id_recurso
                })
                .then(function(response) {
            ...
            eliminarRecurso(data = []) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        this.id_recurso = data["id"];
                        axios.post(this.ruta + "/recursos/eliminar", {
                        id: this.id_recurso
                        })
                        .then(function(response) {
                            me.listarRecurso();
            ...
            abrirModal(modelo, accion, data = []) {
                switch (modelo) {
                    case "recursos": {// libro de el boton nuevo al inicio
                        switch (accion) {
                            case "registrar": {
                            this.modal = 1;
                            this.form.nombre="";
                            this.tituloModal = "Registrar recurso";
                            this.tipoAccion = 1;
                            break;
                            }
                            ...
                            //console.log(data);
                            this.modal = 1;
                            this.tituloModal = "Actualizar recurso";
                            this.tipoAccion = 2;
                            this.id_recurso = data["id"];
