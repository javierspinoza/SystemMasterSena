        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" @click="abrirModal('pensiones','registrar')" class="btn btn-success btn-sm" >
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <md-card-actions>
                            <md-button type="submit" v-if="tipoAccion==2" class="md-dense md-raised md-primary" :disabled="sending" @click="actualizarPension()">Actualizar</md-button>
                        </md-card-actions>
                    </div>
                </div>
                <!-- /.modal-content -->
        ...
        methods: {
            ...
            listarPension() {
                ...
                axios.get(this.ruta + url).then(function (response) {
                    ...
                    me.arrayPension = respuesta.pensiones.data;
                    me.myTable(me.arrayPension);
                })
            ...
            let me = this;
                ...
                $(document).ready(function() {
                    ...
                    $('#dataTable tbody').on( 'click', '.editar', function () {
                        ...
                        me.abrirModal('pensiones','actualizar',me.datos);
                    });
                    $('#dataTable tbody').on( 'click', '.eliminar', function () {
                        me.datos= table.row( $(this).parents('tr') ).data();
                        me.eliminarPension(me.datos);
                    });
                });
            },
            registrarPension() {
                let me = this;
                    axios.post(this.ruta + '/pension/registrar',{
            ...
            axios
                .put(this.ruta + "/pension/actualizar", {
                nombre: this.form.nombre.toUpperCase(),
                id: this.id_pension
                })
                .then(function(response) {
            ...
            eliminarPension(data = []) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        this.id_pension = data["id"];
                        axios.post(this.ruta + "/pension/eliminar", {
                        id: this.id_pension
                        })
                        .then(function(response) {
                            me.listarPension();
            ...
            abrirModal(modelo, accion, data = []) {
                switch (modelo) {
                    case "pensiones": {// libro de el boton nuevo al inicio
                        switch (accion) {
                            case "registrar": {
                            this.modal = 1;
                            this.form.nombre="";
                            this.tituloModal = "Registrar Fondo de Pensión";
                            this.tipoAccion = 1;
                            break;
                            }
                            ...
                            //console.log(data);
                            this.modal = 1;
                            this.tituloModal = "Actualizar Fondo de Pensión";
                            this.tipoAccion = 2;
                            this.id_pension = data["id"];
