        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> EPS 
                    <button type="button" @click="abrirModal('salud','registrar')" class="btn btn-success btn-sm" >
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <md-card-actions>
                            <md-button type="submit" v-if="tipoAccion==2" class="md-dense md-raised md-primary" :disabled="sending" @click="actualizarSalud()">Actualizar</md-button>
                        </md-card-actions>
                    </div>
                </div>
                <!-- /.modal-content -->
        ...
        methods: {
            ...
            listarSalud() {
                ...
                axios.get(this.ruta + url).then(function (response) {
                    ...
                    me.arraySalud = respuesta.salud.data;
                    me.myTable(me.arraySalud);
                })
            ...
            let me = this;
                ...
                $(document).ready(function() {
                    ...
                    $('#dataTable tbody').on( 'click', '.editar', function () {
                        ...
                        me.abrirModal('salud','actualizar',me.datos);
                    });
                    $('#dataTable tbody').on( 'click', '.eliminar', function () {
                        me.datos= table.row( $(this).parents('tr') ).data();
                        me.eliminarSalud(me.datos);
                    });
                });
            },
            registrarSalud() {
                let me = this;
                    axios.post(this.ruta + '/salud/registrar',{
            ...
            axios
                .put(this.ruta + "/salud/actualizar", {
                nombre: this.form.nombre.toUpperCase(),
                id: this.id_salud
                })
                .then(function(response) {
            ...
            eliminarSalud(data = []) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        this.id_salud = data["id"];
                        axios.post(this.ruta + "/salud/eliminar", {
                        id: this.id_salud
                        })
                        .then(function(response) {
                            me.listarSalud();
            ...
            abrirModal(modelo, accion, data = []) {
                switch (modelo) {
                    case "salud": {// libro de el boton nuevo al inicio
                        switch (accion) {
                            case "registrar": {
                            this.modal = 1;
                            this.form.nombre="";
                            this.tituloModal = "Registrar eps";
                            this.tipoAccion = 1;
                            break;
                            }
                            ...
                            //console.log(data);
                            this.modal = 1;
                            this.tituloModal = "Actualizar eps";
                            this.tipoAccion = 2;
                            this.id_salud = data["id"];
