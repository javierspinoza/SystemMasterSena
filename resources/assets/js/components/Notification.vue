            ...
            <div v-if="notifications.length">
                <li v-for="item in listar" :key="item.id">
                    <a class="dropdown-item" href="#">
                        <i class="fa fa-envelope-o"></i> {{item.libro.msj}}
                        <span class="badge badge-success">{{item.libro.numero}}</span>
                    </a>
                    <a class="dropdown-item" href="#">
                        <i class="fa fa-envelope-o"></i> {{item.arl1.msj}}
                        <span class="badge badge-success">{{item.arl1.numero}}</span>
                    </a>
                </li>
            </div>
            <div v-else>
