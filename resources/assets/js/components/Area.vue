        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" @click="abrirModal('areas','registrar')" class="btn btn-success btn-sm" >
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <md-card-actions>
                            <md-button type="submit" v-if="tipoAccion==2" class="md-dense md-raised md-primary" :disabled="sending" @click="actualizarArea()">Actualizar</md-button>
                        </md-card-actions>
                    </div>
                </div>
                <!-- /.modal-content -->
    ...
    export default {
        ...
        methods: {
            ...
            let me = this;
                ...
                $(document).ready(function() {
                    ...
                    $('#dataTable tbody').on( 'click', '.editar', function () {
                        ...
                        me.abrirModal('areas','actualizar',me.datos);
                    });
                    $('#dataTable tbody').on( 'click', '.eliminar', function () {
                        me.datos= table.row( $(this).parents('tr') ).data();
                        me.eliminarArea(me.datos);
                    });
                });
            },
            registrarArea() {
                let me = this;
                    axios.post(this.ruta + '/area/registrar',{
            ...
            eliminarArea(data = []) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        this.id_area = data["id"];
                        axios.post(this.ruta + "area/eliminar", {
                            id: this.id_area
                        })
                        .then(function(response) {
                            me.cerrarModal();
            ...
            abrirModal(modelo, accion, data = []) {
                switch (modelo) {
                    case "areas": {// libro de el boton nuevo al inicio
                        switch (accion) {
                            case "registrar": {
                            this.modal = 1;
                            this.form.nombres="";
