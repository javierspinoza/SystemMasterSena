    ...
    <head>
        ...
        <meta name="description" content="Sistema Contratación Sena">
        ...
        {{-- id para notificacion --}}
        <meta name="userId" content="{{ Auth::check() ? Auth::user()->id : ''}}">

        <title>Contratación Sena</title>
            ...
            @if(Auth::check())
                @if (Auth::user()->idrol == 1)  
                    ...
                    @elseif (Auth::user()->idrol == 4)
                        @include('plantilla.sidebarContratista')
                    @elseif (Auth::user()->idrol == 5)
                        @include('plantilla.sidebarPlanta')
                    @else
