...
class CreateRolesTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('roles')->insert(array('id'=>'4','nombre'=>'Contratista', 'descripcion'=>'Area contratistas'));
        DB::table('roles')->insert(array('id'=>'5','nombre'=>'Planta', 'descripcion'=>'Area de planta'));
